...
public class FlowResource extends ApplicationResource {
    ...
    public Response getAboutInfo() {
        ...
        aboutDTO.setYouTubeChannelUrl(properties.getProperty(NiFiProperties.YOUTUBE_URL));
        aboutDTO.setRabbitUrl(properties.getProperty(NiFiProperties.RABBIT_URL));
        aboutDTO.setKibanaUrl(properties.getProperty(NiFiProperties.KIBANA_URL));
        aboutDTO.setGrafanaUrl(properties.getProperty(NiFiProperties.GRAFANA_URL));
